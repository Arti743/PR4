...
namespace PR4
{
    public partial class FormTypeCircle : Form
    {
        DataSet data;
        SqlDataAdapter adap;
        ...
        string sql = "SELECT * FROM Type_Cirle";



        public FormTypeCircle()
        {
            InitializeComponent();
        ...
        private void button_Save_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                adap.InsertCommand = new SqlCommand("ADD_Type_Cirle", connection);
                adap.InsertCommand.CommandType = CommandType.StoredProcedure;
                adap.InsertCommand.Parameters.Add(new SqlParameter("@Name_type", SqlDbType.VarChar, 60, "Name_type"));
        ...
        {
            openchild(panel1, new FormTypeCircle());
        }
    }
}
